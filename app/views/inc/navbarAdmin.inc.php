<nav class="navbar navbar-expand-lg navbarMe">
  <div class="container-fluid containerME">
    <a class="navbar-brand logo" href="<?php echo URLROOT; ?>admins/dashboard"><img src="<?= URLROOT ?>image/ShipCruiseTour.png" alt="logo" class="logoImg"></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav mx-auto ulMe">
        <a class="nav-link active" href="<?php echo URLROOT; ?>admins/dashboard">Dashboard</a>
        ...
        <a class="nav-link active" href="<?php echo URLROOT; ?>admins/typeChambre">Type Chambre</a>
      ...
      <div style="margin-left: 0px !important;" class="navbar-nav ms-auto ulMe">
        ...
        <ul class="dropdown-menu dropMe">
            ...
            <li><a class="dropdown-item aliMe" href="<?= URLROOT?>admins/logout">Logout</a></li>
        </ul>
      </div>
